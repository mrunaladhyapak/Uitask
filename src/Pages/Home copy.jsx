...
export default function Home() {
    ...
    const images = [
        { id: 1, src: "../assets/images/cartoon.png", alt: "cartoon" },
        { id: 2, src: "https://via.placeholder.com/300?text=Image+2", alt: "Image 2" },
        { id: 3, src: "https://via.placeholder.com/300?text=Image+3", alt: "Image 3" },
        { id: 4, src: "https://via.placeholder.com/300?text=Image+4", alt: "Image 4" },
        { id: 5, src: "https://via.placeholder.com/300?text=Image+5", alt: "Image 5" },
    ...
    const handlePrev = () => {
        setActiveIndex((prev) => (prev === 0 ? images.length - 1 : prev - 2));
    };

    const handleNext = () => {
        setActiveIndex((prev) => (prev === images.length - 1 ? 0 : prev + 2));
    };
        ...
        <div className='homestyle'>
            <div className="black-background">
                <div className="content">
                    <h1>MoonBoxes.io</h1>
                    <p>Your base to purchase NFTs</p>
                </div>
            </div>
